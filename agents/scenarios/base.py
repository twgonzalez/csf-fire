    ...
    def compute_delta_t(
        ...
        for path in serving_paths:
            ...
            results.append({
                ...
                "bottleneck_cross_street_a":     getattr(path, "bottleneck_cross_street_a", ""),
                "bottleneck_cross_street_b":     getattr(path, "bottleneck_cross_street_b", ""),
                "bottleneck_distance_mi":        getattr(path, "bottleneck_distance_mi", 0.0),
                "bottleneck_bearing":            getattr(path, "bottleneck_bearing", ""),
